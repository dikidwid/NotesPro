...
protocol HabitListViewModelProtocol: ObservableObject {
    ...
    func addNewHabit(_ habit: HabitModel) 
}

class HabitListViewModelMock: HabitListViewModelProtocol {
    ...
    init(getHabitsUseCase: GetHabitsUseCase,
         ...
         updateHabitEntryNoteUseCase: UpdateHabitEntryUseCase
    ) {
